...
export default function EditProfilePage() {
  ...
  const [username, setUsername] = useState(localData ? localData.username : "");
  const [email, setEmail] = useState(localData ? localData.email : "");
  const [subscriber, setSubscriber] = useState(
    localData && localData.subscriber
  );
  // Password Management
  ...
  const [religion, setReligion] = useState(localData ? localData.religion : "");
  const [maritalStatus, setMaritalStatus] = useState(
    localData ? localData.maritalStatus : ""
  );
  const [fatherName, setFatherName] = useState(
    localData ? localData.fatherName : ""
  );
  const [motherName, setMotherName] = useState(
    localData ? localData.motherName : ""
  );
  const [companyName, setCompanyName] = useState(
    localData ? localData.companyName : ""
  );
  const [occupation, setOccupation] = useState(
    localData ? localData.occupation : ""
  );
  const [hobbies, setHobbies] = useState(localData ? localData.hobbies : "");
  // Social Media
  const [facebook, setFacebook] = useState(
    localData ? localData.socialMedia[0] : ""
  );
  const [twitter, setTwitter] = useState(
    localData ? localData.socialMedia[1] : ""
  );
  const [github, setGithub] = useState(
    localData ? localData.socialMedia[2] : ""
  );
  const [insta, setInsta] = useState(localData ? localData.socialMedia[3] : "");
  ...
  // Show snackbar
  useEffect(() => {
    if (updatedData && updatedData.username) setUpdateSnackBar(true);
  }, [updatedData]);
  ...
  // Check Password
  useEffect(() => {
    localData && dispatch(checkPass({ _id: localData._id, password }));
    if (password === "") {
      setNewPassword("");
      setReNewPassword("");
    }
  }, [password, dispatch, localData]);
